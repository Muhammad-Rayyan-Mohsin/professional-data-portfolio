...
function TechIcon({ tech }: { tech: TechItem }) {
  return (
    <div className="flex flex-col items-center gap-2 px-6 md:px-8 shrink-0 opacity-60 grayscale hover:grayscale-0 hover:opacity-100 transition-[filter,opacity] duration-500 cursor-pointer">
      ...
      <img
        ...
        loading="lazy"
      />
      <span className="text-xs text-zinc-500 font-medium whitespace-nowrap">{tech.name}</span>
    </div>
  )
}
