  ...
  return (
    <div className="relative min-h-screen">
      ...
      <main className="relative z-10 max-w-3xl mx-auto px-6 py-12 md:py-24 mb-32">
        ...
        {/* Header / Hero */}
        <header className="flex flex-col-reverse md:flex-row justify-between items-center gap-8 mb-24">
          <div className="flex-1 space-y-6">
            <div className="space-y-2">
              ...
              <p className="text-xl text-zinc-400 font-light">AI Engineer & Researcher</p>
            </div>
          ...
          <div className="relative w-44 md:w-56 shrink-0 glitch-wrapper">
            <Image
              src="/IMG_1865.jpeg"
              alt="Profile Photo"
              width={224}
        ...
        {/* Stats Row */}
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-24 py-8 border-y border-zinc-800/50">
        ...
        {/* Featured Projects */}
        <section id="projects" className="mb-24 space-y-8 scroll-mt-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-4 p-3 rounded-xl bg-zinc-800/30 border border-zinc-700/30 hover:border-zinc-600 transition-colors"
                >
                  <div className="w-10 h-10 rounded-full bg-zinc-800/60 flex items-center justify-center border border-zinc-700/50 overflow-hidden">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-zinc-500">{company.role} · {company.period}</div>
                  </div>
                </a>
              ))}
            </div>
        ...
        <section id="contact" className="border-t border-zinc-900 pt-12 pb-8 scroll-mt-24">
          <div className="flex flex-col items-center text-center gap-6">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              <button className="px-8 py-2.5 rounded-lg border border-zinc-700 hover:bg-zinc-800 text-zinc-300 hover:text-white transition-colors text-sm font-medium flex items-center justify-center gap-2">
                <FileText className="w-4 h-4" /> Read CV
              </button>
              <a
                href="/cv.html"
                download="Muhammad_Rayyan_Mohsin_CV.html"
                className="px-8 py-2.5 rounded-lg border border-zinc-700 hover:bg-zinc-800 text-zinc-300 hover:text-white transition-colors text-sm font-medium flex items-center justify-center gap-2"
              >
                <Download className="w-4 h-4" /> Download CV
              </a>
              <a
                href="mailto:mo.rayyan2002@gmail.com"
                className="px-8 py-2.5 rounded-lg bg-white text-black hover:bg-zinc-200 transition-colors text-sm font-medium flex items-center justify-center gap-2"
              >
